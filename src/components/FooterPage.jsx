export const FooterPage = () => {
  return (
    <div className="flex dark:bg-[#111827] bg-[#F9FAFB] w-[full] justify-center">
      <div className="lg:px-20 py-6 flex items-center gap-2 text-[#4B5563] dark:text-[#D1D5DB] text-[14px] leading-5 font-normal ">
        <svg
